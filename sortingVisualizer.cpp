...
{
	glColor3f(0, 0, 1);
	char dp[] = "DYNAMIC SORTING ALGORITHM VISUALIZER";
	bitmap_output(150, 665, dp, GLUT_BITMAP_TIMES_ROMAN_24);
	...
	char dp1[] = "This program sorts a random set of numbers in ascending order displaying them graphically as ";
	char dp2[] = "bars with varying height";
	bitmap_output(10, 625, dp1, GLUT_BITMAP_9_BY_15);
	bitmap_output(10, 605, dp2, GLUT_BITMAP_9_BY_15);


	if (sorting == 0)	// if not sorting display menu
	{
		char m[] = "MENU", s[] = "Press s to SORT", c[]= "Press c to SELECT the sort algorithm", r[]= "Press r to RANDOMISE";
		char e[] = "Esc to QUIT", ss[] = "Selected sort: ";
		bitmap_output(10, 575, m, GLUT_BITMAP_9_BY_15);
		bitmap_output(10, 555, s, GLUT_BITMAP_9_BY_15);
		bitmap_output(10, 535, c, GLUT_BITMAP_9_BY_15);
		bitmap_output(10, 515, r, GLUT_BITMAP_9_BY_15);
		bitmap_output(10, 495, e, GLUT_BITMAP_9_BY_15);
		bitmap_output(10, 475, ss, GLUT_BITMAP_9_BY_15);
		char bubble[] = "Bubble Sort";
		char select[] = "Selection  Sort";
		char insert[] = "Insertion Sort";
		char ripple[] = "Ripple Sort";
		if (sort_count == 0)
			bitmap_output(150, 475, bubble, GLUT_BITMAP_9_BY_15);
		else if(sort_count == 1)
			bitmap_output(150, 475, select, GLUT_BITMAP_9_BY_15);
		else if (sort_count == 2)
			bitmap_output(150, 475, insert, GLUT_BITMAP_9_BY_15);
		else if(sort_count == 3)
			bitmap_output(150, 475, ripple, GLUT_BITMAP_9_BY_15);
	}
	else if (sorting == 1)	// while sorting
	{
		glColor3f(0.5, 0.5, 0.5);
		char s[] = "Sorting in progress...";
		char s1[] = "Press p to PAUSE";
		bitmap_output(10, 555, s, GLUT_BITMAP_9_BY_15);
		bitmap_output(10, 535, s1, GLUT_BITMAP_9_BY_15);
...
void front()
{
	...
	char w[] = "WELCOME!";
	char w1[] = "TO";
	bitmap_output(300, 565, w, GLUT_BITMAP_TIMES_ROMAN_24);
	glBegin(GL_LINE_LOOP);
	glVertex2f(295, 560);
	glVertex2f(395, 560);
	glEnd();
	bitmap_output(330, 525, w1, GLUT_BITMAP_TIMES_ROMAN_24);
	glBegin(GL_LINE_LOOP);
	glVertex2f(325, 521);
	glVertex2f(360, 521);
	glEnd();
	char d[] = "DYNAMIC SORTING ALGORITHM VISUALIZER";
	char d1[] = "Press Enter to continue.......";
	bitmap_output(150, 475, d, GLUT_BITMAP_TIMES_ROMAN_24);
	glBegin(GL_LINE_LOOP);
	glVertex2f(145, 470);
	glVertex2f(520, 470);
	glEnd();
	...
	bitmap_output(530, 125, d1, GLUT_BITMAP_HELVETICA_18);
}
