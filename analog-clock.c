...
void num()
{
	...
	char eleven[] = "11";
	char twelve[] = "12";
	print(-6.1, 0.1, nine); //counting from center
	print(-0.195, -5.9, twelve);
	print(-0.1, 6.1, six);
	print(5.9, 0.1,three);
	print(5.0, 3.2, four);
	print(2.9, 5.45, five);
	print(-3.2, 5.45, seven);
	print(-5.4, 3.2, eight);
	print(-5.5, -2.8, ten);
	print(-3.3, -5.05, eleven);
	print(5.1, -2.8, two);
	print(2.9, -5.05, one);
}
...
void display_clock()
{
	...
	printAt(0, 20, "To move near, press +");
	printAt(0, 10, "To move away, press -");
